...
char _7SEG[] =
		...
		(0x07),(0x7F),(0x6F), //0-9
		(0x77),(0x7C),(0x39),(0x5E),(0x79),(0x71),(0x3D),(0x76),(0x06),(0x1E),(0x7A),
		(0x38),(0x15),(0x54),(0x3F),(0x73),(0x67),(0x50),(0x6D),(0x78),(0x3E),(0x62),
		(0x2A),(0x64),(0x6E),(0x5B), //A-Z
		(0x80),(0x48),(0x01),(0x02),(0x04),(0x08),(0x10),(0x20),(0x40),(0x00)//miscellaneous
		};
...
*******************************************************************************/
	...
	{
		if(((HexValue >> (digit*4)) & 0xF) == 0xA){ //Allows to Use 0xA as a space for displaying the time
			Seven_Segment_Digit(digit,SPACE, 0);
		} else {
